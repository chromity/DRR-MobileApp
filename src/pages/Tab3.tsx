...
const Tab3Page: React.FC = () => {
    ...
    useIonViewWillEnter(async () => {
        const result = await fetch("https://cors-anywhere.herokuapp.com/http://139.99.124.43:3000/monitoring/get_incidents")
    ...
    return (
        <IonCard>
            ...
            <IonCardHeader className="tweetCardHeader">
                <IonCardTitle><h5>SYSTEM DETECTED {tweet.hazard}</h5></IonCardTitle>
